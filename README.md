...
Веб-приложение для практики японского: кана, кандзи JLPT N5–N3, числа и словарь. Прогресс тренировок и «Мои слова» хранятся локально в браузере (`localStorage`).
...
Состояние приложения — схема **v14** (`kana` / `numbers` / `kanji` / `vocab` с тренировкой и своими словами). Старые ключи и версии мигрируются при загрузке.
